...
void Echange::setup()
{
    ...
    this->gui.add( this->flockingForces.setup( "flockingForces", ofVec3f(0.01, 0.5, 1.0), ofVec3f(0.0), ofVec3f(0.4, 1.0, 2.0) ) );
    ...
    this->gui.add( this->tailleParticule.setup( "tailleParticule", 0.06, 0.001, 0.4 ) );
    ...
    this->gui.add( this->zoom.setup( "zoom", 2.0, 0.1, 4.0 ) );
